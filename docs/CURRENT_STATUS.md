...
- الواجهة السابقة دمجت في main؛ صيانة الأيقونة والمبالغ موثقة في `MAINTENANCE_2026-09-17.md`.
...
نجحت 42 دالة اختبار عبر kotlinc محليًا. لا يتوفر تنزيل Gradle أو تشغيل Android محليًا؛ CI على الرأس نفسه هي مرجع unit/lint/APK/schema، وليست بوابة أغسطس أدناه. لم تشغل اختبارات الجهاز أو المحاكي لهذه الجولة؛ أزيل المحاكي من CI الافتراضية في سبتمبر. Schema والسجل المالي دون تعديل.
