...
## 0.1.1 — إصلاح الأيقونة وسلامة إدخال المبالغ

- إزالة `wasl_launcher_art.png` غير القابل لفك الترميز واستبداله برسم متجهي تتبّع حروف الشعار من التصميم المعتمد، دون الاعتماد على خط خارجي.
- توحيد هندسة الأيقونة الملونة وأحادية اللون والإشعارات، بخلفية ممتدة وهوامش آمنة للأقنعة الدائرية والمربعة.
- تصحيح الإدخال الذكي: الكسور والفواصل العربية والفارسية لا تتحول إلى بادئة عددية ناقصة، وتجاوز Long يعيد مسودة تحتاج تصحيحًا بدل رمي استثناء في الواجهة.
- رفض المبالغ الرقمية المتعددة أو الملتبسة في الإدخال الذكي بدل اختيار أول رقم أو جزء من تاريخ.
- التحقق من مجموعات الآلاف قبل إزالة الفواصل؛ رفض الصيغة العلمية والنصوص الطويلة مبكرًا. التحويل المالي يبقى صحيحًا بوحدات Long دون تقريب.
- إضافة اختبارات انحدار للأيقونة ولإدخال المال، ورفع versionCode إلى 2.
- لا تعديل في Room v11 أو البيانات المحفوظة أو قواعد Ledger أو التوقيع أو صلاحيات التطبيق.
