...
- تغطي الاختبارات المال، Parsing العربي الدقيق، إعادة فتح قاعدة البيانات، إنشاء عدة ديون للشخص نفسه، رحلة الدفع، استعلامات Today والبحث واختيار الأشخاص، التزامن، القيود وMigration baseline.
